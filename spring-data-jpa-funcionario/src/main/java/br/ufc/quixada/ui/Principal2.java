...
public class Principal2 implements CommandLineRunner {
    @Autowired
    private FuncionarioDAO databaseFunc;

    public static void main(String[] args) {
        //SpringApplication.run(Principal.class, args);
        SpringApplicationBuilder builder = new SpringApplicationBuilder(Principal2.class);
    ...
    public static void obterFuncionario(FuncionarioDAO database, Funcionario funcionario) {
        ...
        if(!cpf.equals(funcionario.getCpf())){//se o cpf que o funcionario inseriu foi diferente
            if(database.findFirstByCpf(cpf) != null){//verifica se o novo cpf existe no sistema
            ...
            switch (opcao){
                ...
                case '2'://Deletar
                    ...
                    if(opcaoDeletar == '1'){
                        ...
                        f = databaseFunc.findFirstByCpf(campo);
                        if (f != null) {
                            databaseFunc.delete(f);
                        ...
                        f = databaseFunc.findMatricula(campo);
                        if (f != null) {
                            databaseFunc.delete(f);
                            JOptionPane.showMessageDialog(null, "Funcionário deletado do sistema.");
                        } else {
                ...
                case '4'://Consulta
                    ...
                    if(opcaoConsulta == '1'){
                        ...
                        listaFuncionarios(databaseFunc.findAll());
                        ...
                        funcionarios = databaseFunc.findName(campo);
                        listaFuncionarios(funcionarios);
                    }else if(opcaoConsulta == '5'){
                        //Consulta por email
                        campo = JOptionPane.showInputDialog("Email");
                        f = databaseFunc.findEmail(campo);
                        listaFuncionario(f);
